...
export const ChatBot = () => {
  ...
  const [chatHistory, setChatHistory] = useState<ChatMessage[]>([
    {
      id: '1',
      text: 'Halo! Saya asisten virtual SATU GIZI. Ada yang bisa saya bantu terkait platform vendor ini?',
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const newBotMsg: ChatMessage = {
        ...
        text: 'Maaf, saat ini saya masih dalam tahap pengembangan. Fitur percakapan pintar akan segera hadir!',
        sender: 'bot',
        timestamp: new Date()
      };
