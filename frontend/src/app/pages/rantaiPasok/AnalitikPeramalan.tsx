...
import { demandForecast, priceForecast, regionBalances, redistRecommendations } from "../../data";
            ...
            {redistRecommendations.map((rec, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08 }}>
                <Card>
                  ...
                  <Button className="w-full mt-3" icon={ArrowRight} onClick={() => toast(`Redistribusi ${rec.from} → ${rec.to} dijadwalkan.`)}>Jadwalkan Redistribusi</Button>
                </Card>
              </motion.div>
            ))}
          </div>
